...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">{{ __('Registro en Nutribite') }}</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="user_type" class="form-control @error('user_type') is-invalid @enderror" name="user_type" required>
                                    ...
                                    <option value="nutritionist" {{ old('user_type') == 'nutritionist' ? 'selected' : '' }}>Nutricionista</option>
                                </select>
                                @error('user_type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
